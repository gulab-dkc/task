...
#     subject = "Welcome to task_tracker_project Pvt Ltd."
#     message = f"""
#     Dear {email},

#     I trust this message finds you in good health. It is my distinct pleasure to welcome you to task_tracker_project Pvt Ltd, an esteemed platform dedicated to excellence.
...
#     task_tracker_project Pvt Ltd, under the leadership of task_tracker_project, Director, is committed to fostering a transformative and enriching experience. We firmly believe that your presence will contribute significantly to the vibrancy of our community.

#     For any inquiries or assistance, please do not hesitate to reach out to task_tracker_project directly at {from_email}.

#     We appreciate your consideration of our invitation and eagerly anticipate the prospect of welcoming you into the task_tracker_project Pvt Ltd community.

#     Best regards,

#     task_tracker_project
#     Director, task_tracker_project Pvt Ltd
#     {from_email}
#     """
...
#     plt.tight_layout()
#     plt.savefig('emp_app/static/CHARTS/task_distribution.png')
#     plt.close()
...
#     # Save the plot
#     plt.savefig('emp_app/static/CHARTS/remaining_tasks.png')
#     plt.close()
...
#     plt.savefig('emp_app/static/CHARTS/completed_tasks_over_time.png')
#     plt.close()
...
#     # Save the plot
#     plt.savefig('emp_app/static/CHARTS/employee_performance.png')
#     plt.close()
...
#     plt.tight_layout()
#     plt.savefig('emp_app/static/CHARTS/task_description_wordcloud.png')
#     plt.close()
...
#     plt.xticks(rotation=45)
#     plt.tight_layout()
#     plt.savefig('emp_app/static/CHARTS/completion_rate_by_employee.png')
#     plt.close()
...
#     plt.xticks(rotation=45)
#     plt.tight_layout()
#     plt.savefig('emp_app/static/CHARTS/task_distribution_by_category.png')
#     plt.close()
...
#     plt.tight_layout()
#     plt.savefig('emp_app/static/CHARTS/task_distribution_by_priority.png')
#     plt.close()
